            ...
            <div class="row g-4">
                ...
                <div class="col-lg-2 col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="products.php" class="text-muted text-decoration-none">Products</a></li>
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="#" class="text-muted text-decoration-none">Equipment Procurement</a></li>
                        <li class="mb-2"><a href="#" class="text-muted text-decoration-none">IT Setup & Configuration</a></li>
                        <li class="mb-2"><a href="#" class="text-muted text-decoration-none">Technical Support</a></li>
                        <li class="mb-2"><a href="#" class="text-muted text-decoration-none">Equipment Repair</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <ul class="list-unstyled text-muted">
                        ...
                        <li class="mb-2"><i class="fas fa-phone me-2"></i>+1 (404) 939-1635</li>
                        <li class="mb-2"><i class="fas fa-envelope me-2"></i>protechsolutions@gmx.us</li>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <div class="d-flex gap-4 justify-content-md-end">
                        ...
                        <a href="#" class="text-muted text-decoration-none small">Security</a>
                    </div>
                </div>
            </div>
        </div>
